...
public class PmodelController implements Initializable {
    ...
    @FXML private TextField txtNivelInventarioActual;
    ...
    public void Calcular()
    {
        if (txtPlazo.getText().isEmpty()==true|| 
                ...
                txtNivelInventarioActual.getText().isEmpty()==true|| 
        ...
        else
        {
            if (txtPlazo.getText().equals("0")==true || 
                ...
                txtNivelInventarioActual.getText().equals("0")==true || 
            ...
            else
            {
                    ...
                    I = Integer.parseInt(txtNivelInventarioActual.getText());
    ...
    public void LimpiarCampos()
    {
        ...
        txtNivelInventarioActual.clear();
    ...
    public void initialize(URL url, ResourceBundle rb) 
    {
        ...
        txtNivelInventarioActual.setOnKeyTyped(e->{ Validar(e);});
